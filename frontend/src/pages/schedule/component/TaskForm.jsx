  ...
  const handleSubmitEvent = async (formData) => {
    ...
    if (isNewAppointment) {
      await addNewEvent({
        ...
        startTime: `${parseStartDate.getYear}-${parseStartDate.getMonth}-${parseStartDate.getDay}T${parseStartTime.getHour}:${parseStartTime.getMinus}Z`,
        endTime: `${parseStartDate.getYear}-${parseStartDate.getMonth}-${parseStartDate.getDay}T${parseEndTime.getHour}:${parseEndTime.getMinus}Z`,
        colorCode: formData.colorCode.hex,
        notiBeforeTime: Number(formData.notiBeforeTime),

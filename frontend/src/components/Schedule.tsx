...
// #FOLD_BLOCK
const ShadeCellsCheckBox = (shadePreviousCells:any, handleChange:any) => (
  <FormControlLabel
    control={(
      <Checkbox
...
// #FOLD_BLOCK
const ShadePreviousAppointmentsCheckBox = (shadePreviousAppointments:any, handleChange:any) => (
  <FormControlLabel
    control={(
      <Checkbox
...
const CheckBoxContainer = ((
  shadePreviousCells:any, shadePreviousAppointments:any, handleCheckboxChange:any,
  // #FOLD_BLOCK
) => (
...
const UpdateIntervalBox = ((
  updateInterval:any, onValueChange:any,
  // #FOLD_BLOCK
) => (
...
export default function App(){
  ...
  //   };
  // }
function handleUpdateIntervalChange(nextValue:any){
 setState({
    updateInterval: nextValue * 1000,
  });
};
  function handleCheckboxChange(stateField) {
